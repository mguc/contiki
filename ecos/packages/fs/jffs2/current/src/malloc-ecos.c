...
{
	return vmalloc(sizeof(struct jffs2_full_dirent) + namesize);
}
...
{
	return vmalloc(sizeof(struct jffs2_full_dnode));
}
...
{
	return vmalloc(sizeof(struct jffs2_raw_dirent));
}
...
{
	return vmalloc(sizeof(struct jffs2_raw_inode));
}
...
{
	return vmalloc(sizeof(struct jffs2_tmp_dnode_info));
}
...
{
	return vmalloc(sizeof(struct jffs2_node_frag));
}
...
{
	return vmalloc(sizeof(struct jffs2_raw_node_ref));
}
...
{
	struct jffs2_inode_cache *ret = vmalloc(sizeof(struct jffs2_inode_cache));
