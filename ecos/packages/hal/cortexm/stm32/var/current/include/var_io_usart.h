...
// temporary turned off, however the pins should have an option NONE
#define CYGHWR_HAL_STM32_UART3_CTS              CYGHWR_HAL_STM32_GPIO_NONE//stm32_serial_pin_in( CYGHWR_HAL_STM32_UART2_PIN_CTS,  7)
#define CYGHWR_HAL_STM32_UART3_RTS              CYGHWR_HAL_STM32_GPIO_NONE//stm32_serial_pin_rts_out( CYGHWR_HAL_STM32_UART2_PIN_RTS )
