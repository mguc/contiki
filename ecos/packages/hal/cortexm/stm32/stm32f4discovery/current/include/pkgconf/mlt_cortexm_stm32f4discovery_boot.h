...
#define CYGMEM_REGION_ram_SIZE (0x00030000-CYGNUM_HAL_COMMON_INTERRUPTS_STACK_SIZE)
...
#define CYGMEM_REGION_flash (0x0804000C)
#define CYGMEM_REGION_flash_SIZE (0x1BFFF4)
