...
#elif defined(CYGHWR_HAL_CORTEXM_STM32_F429)
// 2048K
#define STM32_FLASH_SIZE              (2*1024*1024)
#define STM32_FLASH_BLOCK_INFO        { { { 16*1024, 4 } , { 64*1024, 1 }, { 128*1024, 7 }, { 16*1024, 4 } , { 64*1024, 1 }, { 128*1024, 7 } } }
#define STM32_FLASH_NUM_BLOCK_INFOS   6
...
cyg_stm32_flash_dev hal_stm32_flash_priv = { { STM32_FLASH_BLOCK_SIZE, STM32_FLASH_SIZE / STM32_FLASH_BLOCK_SIZE } };
#elif defined(STM32_FLASH_BLOCK_INFO)
cyg_stm32_flash_dev hal_stm32_flash_priv = STM32_FLASH_BLOCK_INFO;
#else
